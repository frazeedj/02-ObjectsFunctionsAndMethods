...
def main():
    ...
    even_better_draw_circles(rg.Point(4,4),20,10,'orange',9)
    even_better_draw_circles(rg.Point(4,4),15,11,'blue',8)
    even_better_draw_circles(rg.Point(4,4),10,12,'yellow',7)
    even_better_draw_circles(rg.Point(4,4),5,13,'red',6)
    even_better_draw_circles(rg.Point(4,4),3,14,'black',5)
    even_better_draw_circles(rg.Point(4,4),1,15,'green',4)
...
def even_better_draw_circles(point,radius,number_of_circles,pen_color,pen_thickness):
